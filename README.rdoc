{<img src="http://api.travis-ci.org/kazuhisa/ken_all.png" />}[http://travis-ci.org/kazuhisa/ken_all]
= ken_all
...
(3) Options
  ...
  $ rake ken_all:import URI=http://domain/path/to/x-ken-all.zip #外部のサイトからzipファイルをダウンロードして取り込みます(*)
